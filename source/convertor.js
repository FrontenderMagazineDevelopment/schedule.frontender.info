...
const published = articles.filter((article)=>(article.ready === true)&&(article.reponame !== undefined))
const freezed = articles.filter((article)=>(article.ready === false)&&(article.reponame !== undefined))
